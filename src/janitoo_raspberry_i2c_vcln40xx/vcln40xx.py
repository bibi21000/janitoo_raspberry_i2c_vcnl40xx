...
def make_vcln4000(**kwargs):
    return VCLN4000Component(**kwargs)

def make_vcln4010(**kwargs):
...
class VCLN4000Component(JNTComponent):
    ...
    def __init__(self, bus=None, addr=None, **kwargs):
        """
        """
        oid = kwargs.pop('oid', 'rpii2c.vcln4000')
        ...
        self.values[uuid] = self.value_factory['config_integer'](options=self.options, uuid=uuid,
            ...
            label='Addr',
            default=Adafruit_VCNL40xx.VCNL40xx_ADDRESS,
        )
        uuid="proximity"
...
class VCLN4010Component(VCLN4000Component):
    ...
    def __init__(self, bus=None, addr=None, **kwargs):
        """
        """
        oid = kwargs.pop('oid', 'rpii2c.vcln4010')
